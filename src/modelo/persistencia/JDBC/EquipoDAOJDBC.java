...
public class EquipoDAOJDBC implements EquipoDAO {
    ...
    public void update(Equipo contacto) {
       String sql = "update equipos SET pais = ?,pos_grupo = ?,grupo = ? WHERE nombre = ?";;    //"insert into equipos(nombre,pais,pos_grupo,grupo) values (?,?,?,?)";
    ...
    public void delete(Equipo contacto) {
        String sql = "delete from equipos where nombre = ?";;    //"insert into equipos(nombre,pais,pos_grupo,grupo) values (?,?,?,?)";
