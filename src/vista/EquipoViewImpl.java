...
//Con este evento controlamos que hemos clicados en una fila de la tabla
    ...
    protected void refresh() {
        ...
        tableModel.setEquipos(model.obtenerEquipos());
    }

    protected void fireNuevoContactoGesture(String nombre, String pais, String pos_grupo, String grupo) {
        //Añadimos las valdiaciones
        int i;
        i = model.validaciones(nombre, pais, pos_grupo, grupo);
        if (i == 1) {  //Error 2 equipos por grupo
              JOptionPane.showMessageDialog(null, "No se pudo añadir, el grupo "+ grupo+ " ya tiene dos equipos", "Grupo Completo",JOptionPane.ERROR_MESSAGE);   
        }else if(i==2){ //Error dos equipos con la misma posición
